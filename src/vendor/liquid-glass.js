...
function LiquidGlass({
  ...
  useEffect(() => {
    ...
    // offsetWidth/offsetHeight ignore the elastic transform, so the sibling
    // tint/shine layers can't feed back into their own measurement. A
    // ResizeObserver keeps them in sync when the content itself changes size
  ...
  const baseStyle = {
    ...
    transition: animate ? "all ease-out 0.2s" : "none"
  };
